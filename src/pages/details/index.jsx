...
const Details = () => {
    const { id } = useParams()
    const { recipeDetailsData, favoritesList, setRecipeDetailsData, handleToFavorite } = useContext(GlobalContext)
    useEffect(() => {
    ...
    return (
        <div className='container mx-auto py-10 grid grid-cols-1 lg:grid-cols-2 gap-10'>
            ...
            <div className='flex flex-col gap-3'>
                ...
                <div>
                    <button onClick={() => { handleToFavorite(recipeDetailsData?.recipe) }} className='p-3 px-8 rounded-lg text-sm font-medium tracking-wider mt-3 inline-block uppercase bg-black shadow-md text-white'>
                        {
